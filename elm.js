...
var _user$project$Models_Item$Item = F3(
	function (a, b, c) {
		return {id: a, name: b, done: c};
	});
var _user$project$Models_Item$decodeItem = A3(
	...
	A3(
		...
		A3(
			...
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_Item$Item))));

var _user$project$Models_TodoList$TodoList = F3(
	function (a, b, c) {
		return {id: a, title: b, items: c};
	});
var _user$project$Models_TodoList$decodeTodoLists = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'items',
	_elm_lang$core$Json_Decode$list(_user$project$Models_Item$decodeItem),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'title',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models_TodoList$TodoList))));

var _user$project$Route$TodoList = function (a) {
	return {ctor: 'TodoList', _0: a};
};
var _user$project$Route$Home = {ctor: 'Home'};
var _user$project$Route$Login = {ctor: 'Login'};

var _user$project$Models_Model$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {route: a, authToken: b, email: c, password: d, loginError: e, todoLists: f, navbarToggle: g, newTodoName: h, accountMenu: i};
	});
var _user$project$Models_Model$UpdateTodoLists = {ctor: 'UpdateTodoLists'};
var _user$project$Models_Model$AddTodoListDone = function (a) {
	return {ctor: 'AddTodoListDone', _0: a};
};
var _user$project$Models_Model$AddTodoList = {ctor: 'AddTodoList'};
var _user$project$Models_Model$InputNewTodoList = function (a) {
	return {ctor: 'InputNewTodoList', _0: a};
};
var _user$project$Models_Model$ToggleAccountMenu = {ctor: 'ToggleAccountMenu'};
var _user$project$Models_Model$ToggleNavbar = {ctor: 'ToggleNavbar'};
var _user$project$Models_Model$Logout = {ctor: 'Logout'};
var _user$project$Models_Model$UpdatePassword = function (a) {
	return {ctor: 'UpdatePassword', _0: a};
};
var _user$project$Models_Model$UpdateEmail = function (a) {
	return {ctor: 'UpdateEmail', _0: a};
};
var _user$project$Models_Model$GetLists = function (a) {
	return {ctor: 'GetLists', _0: a};
};
var _user$project$Models_Model$LoadTokenData = function (a) {
	return {ctor: 'LoadTokenData', _0: a};
};
var _user$project$Models_Model$Click = {ctor: 'Click'};
var _user$project$Models_Model$ChangeRoute = function (a) {
	return {ctor: 'ChangeRoute', _0: a};
};
var _user$project$Models_Model$Testit = {ctor: 'Testit'};

var _user$project$Pages_Home$todoListView = function (todoList) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Models_Model$ChangeRoute(
					_user$project$Route$TodoList(todoList))),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(todoList.id),
					todoList.title)),
			_1: {ctor: '[]'}
		});
};
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Models_Model$InputNewTodoList),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('form-control'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$placeholder('Name of your todo list'),
																	_1: {ctor: '[]'}
																}
															}
														},
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$AddTodoList),
																		_1: {
																			ctor: '::',
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Create todo list'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Your lists: '),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												A2(_elm_lang$core$List$map, _user$project$Pages_Home$todoListView, model.todoLists)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$Views_Navbar$yellowStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: '#edcb40'},
		_1: {ctor: '[]'}
	});
var _user$project$Views_Navbar$blueStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: '#39bcec'},
		_1: {ctor: '[]'}
	});
var _user$project$Views_Navbar$redStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'color', _1: '#dc443a'},
		_1: {ctor: '[]'}
	});
var _user$project$Views_Navbar$navbarView = function (model) {
	return A2(
		_elm_lang$html$Html$nav,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('navbar navbar-expand-lg sticky-top navbar-dark bg-dark'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Views_Navbar$redStyle,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Views_Navbar$blueStyle,
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Views_Navbar$yellowStyle,
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$ToggleNavbar),
						_1: {
							ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'show', _1: model.navbarToggle},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('navbar-nav mr-auto mt-2 mt-lg-0'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$UpdateTodoLists),
													_1: {
														ctor: '::',
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Central Perk'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('nav-item dropdown'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$classList(
														{
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'show', _1: model.accountMenu},
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$ToggleAccountMenu),
														_1: {
															ctor: '::',
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$Logout),
																	_1: {
																		ctor: '::',
...
var _user$project$Views_Navbar$view = function (model) {
	return _user$project$Views_Navbar$navbarView(model);
};

var _user$project$Pages_Login$loginView = function (model) {
	var errorText = function () {
		var _p0 = model.loginError;
		if (_p0.ctor === 'Just') {
			return A2(
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Models_Model$Click),
					_1: {
						ctor: '::',
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Models_Model$UpdateEmail),
											_1: {
												ctor: '::',
						...
						_1: {
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Models_Model$UpdatePassword),
												_1: {
													ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Models_Model$Click),
										_1: {
											ctor: '::',
...
var _user$project$Pages_Login$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Pages_Login$loginView(model),
			_1: {ctor: '[]'}
		});
};

var _user$project$Pages_TodoList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('hej'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Requests_TodoList$addTodoList = F2(
	function (token, name) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
					ctor: '::',
					_0: A2(_elm_lang$http$Http$header, 'Authorization', token),
					_1: {ctor: '[]'}
				},
				url: 'http://localhost:3000/todos',
				body: A2(_elm_lang$http$Http$stringBody, 'title', name),
				expect: _elm_lang$http$Http$expectString,
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Requests_TodoList$getTodoLists = F2(
...
var _user$project$Requests_Login$decodeToken = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'auth_token',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Requests_Login$postLogin = function (model) {
	...
	return A3(_elm_lang$http$Http$post, url, body, _user$project$Requests_Login$decodeToken);
};

var _user$project$Ports$setAuthToken = _elm_lang$core$Native_Platform.outgoingPort(
	'setAuthToken',
	function (v) {
		return v;
	});
		...
		switch (_p0.ctor) {
				...
				if (_p1.ctor === 'Nothing') {
					...
					return {
						...
						_1: A2(
							...
							_user$project$Models_Model$AddTodoListDone,
							A2(_user$project$Requests_TodoList$addTodoList, _p1._0, model.newTodoName))
					};
				}
			case 'AddTodoListDone':
				if (_p0._0.ctor === 'Ok') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Click':
				return {
					...
					_1: A2(
						_elm_lang$http$Http$send,
						_user$project$Models_Model$LoadTokenData,
						_user$project$Requests_Login$postLogin(model))
				};
			case 'InputNewTodoList':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
				...
				if (_p0._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								authToken: _elm_lang$core$Maybe$Just(_p2),
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								...
								_0: A2(
									_elm_lang$http$Http$send,
									_user$project$Models_Model$GetLists,
									A2(_user$project$Requests_TodoList$getTodoLists, _p2, _user$project$Models_TodoList$decodeTodoLists)),
								_1: {
									ctor: '::',
									_0: _user$project$Ports$setAuthToken(_p2),
									_1: {ctor: '[]'}
								}
							})
					};
				...
				if (_p3.ctor === 'Nothing') {
					...
					return {
						...
						_1: A2(
							_elm_lang$http$Http$send,
							_user$project$Models_Model$GetLists,
							A2(_user$project$Requests_TodoList$getTodoLists, _p3._0, _user$project$Models_TodoList$decodeTodoLists))
					};
				}
			case 'Logout':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							route: _user$project$Route$Login,
							todoLists: {ctor: '[]'},
							accountMenu: false
						}),
					_1: _user$project$Ports$logout('logout')
				};
			case 'ToggleNavbar':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{navbarToggle: !model.navbarToggle}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Main$showBreadcrumb = function (model) {
	var _p0 = model.route;
	switch (_p0.ctor) {
		case 'Login':
			return _elm_lang$html$Html$text('');
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$li,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Models_Model$ChangeRoute(_user$project$Route$Home)),
							_1: {
								ctor: '::',
...
var _user$project$Main$mainContent = function (model) {
	...
	switch (_p1.ctor) {
		case 'Login':
			return _user$project$Pages_Login$view(model);
		case 'Home':
			return _user$project$Pages_Home$view(model);
		default:
			return _user$project$Pages_TodoList$view(model);
	}
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views_Navbar$view(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$showBreadcrumb(model),
				_1: {
					ctor: '::',
...
var _user$project$Main$init = function (flags) {
	var config = function () {
		var _p2 = flags.authToken;
		if (_p2.ctor === 'Nothing') {
			return {route: _user$project$Route$Login, cmd: _elm_lang$core$Platform_Cmd$none};
		} else {
			return {
				route: _user$project$Route$Home,
				cmd: A2(
					_elm_lang$http$Http$send,
					_user$project$Models_Model$GetLists,
					A2(_user$project$Requests_TodoList$getTodoLists, _p2._0, _user$project$Models_TodoList$decodeTodoLists))
			};
		}
	}();
	return {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Models.Model.Msg":{"args":[],"tags":{"GetLists":["Result.Result Http.Error (List Models.TodoList.TodoList)"],"Logout":[],"ToggleNavbar":[],"UpdateEmail":["String"],"InputNewTodoList":["String"],"ToggleAccountMenu":[],"AddTodoListDone":["Result.Result Http.Error String"],"AddTodoList":[],"ChangeRoute":["Route.Route"],"LoadTokenData":["Result.Result Http.Error String"],"UpdateTodoLists":[],"UpdatePassword":["String"],"Click":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Route.Route":{"args":[],"tags":{"Home":[],"TodoList":["Models.TodoList.TodoList"],"Login":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Models.Item.Item":{"args":[],"type":"{ id : Int, name : String, done : Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Models.TodoList.TodoList":{"args":[],"type":"{ id : Int, title : String, items : List Models.Item.Item }"}},"message":"Models.Model.Msg"},"versions":{"elm":"0.18.0"}});
}
